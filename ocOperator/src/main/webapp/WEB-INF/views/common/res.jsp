...
<link href="${baseurl}res/css/style.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="${baseurl}res/js/bootstrap.js"></script>
<script type="text/javascript" src="${baseurl}res/js/highcharts-4.1.min.js"></script>
    ...
    (function ($) {
        window.Ewin = function () {
            var html = '<div id="[Id]" class="modal fade" role="dialog" aria-labelledby="modalLabel">' +
                ...
                '<div class="modal-content" style="width: 300px;height: 184px;margin-left: 1000px;margin-top: 500px">' +
            ...
            var dialogdHtml = '<div id="[Id]" class="modal fade" aria-labelledby="modalLabel" tabindex="-1" role="dialog" aria-hidden="true">' +
